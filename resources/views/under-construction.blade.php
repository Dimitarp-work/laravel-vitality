...
<body class="bg-gray-50">
    <div class="max-w-5xl mx-auto flex flex-col items-center justify-center min-h-screen px-6 py-8">
        <div class="text-center">
            <div class="mb-6">
                <span class="material-icons text-pink-400 text-8xl">construction</span>
            </div>
            <h1 class="text-4xl font-bold text-pink-900 mb-4">Under Construction</h1>
            <h2 class="text-2xl font-semibold text-pink-700 mb-6">Coming Soon!</h2>
