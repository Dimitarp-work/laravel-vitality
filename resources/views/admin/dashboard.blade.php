...
<div class="bg-white rounded-2xl shadow p-6">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-theme-100">
            <thead>
                <tr class="bg-theme-50">
                    <th class="px-4 py-3 text-xs font-semibold text-theme-700 uppercase tracking-wider">User</th>
                    <th class="px-4 py-3 text-xs font-semibold text-theme-700 uppercase tracking-wider">XP Change</th>
                    <th class="px-4 py-3 text-xs font-semibold text-theme-700 uppercase tracking-wider">Credit Change</th>
                    <th class="px-4 py-3 text-xs font-semibold text-theme-700 uppercase tracking-wider">Reason</th>
                    <th class="px-4 py-3 text-xs font-semibold text-theme-700 uppercase tracking-wider">Timestamp</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-theme-100">
                @foreach ($logs as $log)
