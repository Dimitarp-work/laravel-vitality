    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="grid grid-cols-3 gap-2 mb-6">
                <a href="?tab=current" class="{{ $activeTab === 'current' ? 'bg-pink-200 text-pink-800' : 'bg-pink-100 text-pink-600' }} px-4 py-2 rounded-lg text-center font-medium">
                    Current Goals
                </a>
                <a href="?tab=achieved" class="{{ $activeTab === 'achieved' ? 'bg-pink-200 text-pink-800' : 'bg-pink-100 text-pink-600' }} px-4 py-2 rounded-lg text-center font-medium">
                    Achieved
                </a>
                <a href="?tab=badges" class="{{ $activeTab === 'badges' ? 'bg-pink-200 text-pink-800' : 'bg-pink-100 text-pink-600' }} px-4 py-2 rounded-lg text-center font-medium">
                    My Badges
                </a>
            </div>
                            ...
                            <div class="p-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                                        <button class="text-gray-400 hover:text-gray-600 h-8 w-8 p-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </button>
                                        <button class="text-red-400 hover:text-red-600 h-8 w-8 p-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <div class="p-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <p class="text-xs text-gray-500">Achieved on {{ $goal['date'] }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
